...
TEST_P(Args3U8, getValue)
{
    ...
    // act
    const auto kActual = rabbit::BinOps::getValue<U>(kSrc, kSrcOffset, kNBits);
...
TEST_P(Args2U8, getValue)
{
    ...
    // act
    const auto kActual = rabbit::BinOps::getValue<U>(kSrc, kNBits);
...
TEST_P(Args1U8, getValue)
{
    ...
    // act
    const auto kActual = rabbit::BinOps::getValue<U>(kSrc);
