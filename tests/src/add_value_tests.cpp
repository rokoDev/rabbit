...
TEST_P(Args4UInt8, addValue)
{
    ...
    rabbit::Core::addValue(Dst(result.data()), aOffset, aValue, aNBits);
...
TEST_P(Args3UInt8, AddValue)
{
    ...
    auto result = arrangeDst(aDstBitStr);
    rabbit::Core::addValue(Dst(result.data()), aValue, aNBits);
...
TEST_P(Args2UInt8, AddValue)
{
    ...
    auto result = arrangeDst(aDstBitStr);
    rabbit::Core::addValue(Dst(result.data()), aValue);
